...
class HCourseController
{
  public:
    ...
    */
    HCourseController(ros::NodeHandle& nh);
  ...
  private:
    ...
    usv_vrx::HThrustController* thrust_controller_;

    //! State machine for thrust operations.
    usv_vrx::HThrustSM* thrust_sm_;
    ...
    */
    void reconfigureThrusters(HThrustSM::THRUST_STATE state);
    ...
    * @param msg the received message.
    */
    void courseCb(const usv_msg::Course::ConstPtr& msg);
};
