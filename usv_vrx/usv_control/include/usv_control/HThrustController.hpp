...
class HThrustController
{
  public:
    ...
    */
    HThrustController(char thrust_config, float priority_yaw_range, float motor_cmd_limit, float neg_scale_factor, float station_tolerance_ang);
    ...
    */
    void getControlSignalTraverse(float &thrust_right, float &thrust_left, double sim_time=0);
    ...
    * @param sim_time current ROS time.
    */
    void getControlSignalStation(float &thrust_right, float &thrust_left, double sim_time=0);
  ...
  private:
    ...
    */
    ...
    usv_vrx::SimplePID* linearPID_;

    //! PID controller for angular velocity.
    usv_vrx::SimplePID* angularPID_;

    //! PID controller for stationkeeping in x.
    usv_vrx::SimplePID* stationXPID_;

    //! PID controller for stationkeeping in y.
    usv_vrx::SimplePID* stationYPID_;
