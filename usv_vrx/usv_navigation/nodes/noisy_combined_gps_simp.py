...
class GPSCombiner:
    def __init__(self):
        self.gps1_sub = rospy.Subscriber('/noisy_gps_left/gps/fix', NavSatFix, self.gps1_callback)
        self.gps2_sub = rospy.Subscriber('/noisy_gps_right/gps/fix', NavSatFix, self.gps2_callback)
